...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
        ...
        text = re.sub(
            "[ㅂㅁㅋㅈㄴㅌㄷㅇㅊㄱㄹㅍㅅㅎㅃㅉㄸㄲㅆㅠㅛㅗㅜㅕㅓㅡㅑㅏㅐㅣㅔㄺㄼㄽㅃㅉㄸㄲㅆㅀㄿㄾㅘㅚㅟㅝㅞㅢㅙ]", "", text)
        text = re.sub("[\--z]", "", text)
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
        ...
        for i in eng:
            if i == text:
                ge = 7
        eng = ['2girls1cup', '2g1c', '4r5e', '5h1t', '5hit', 'a$$hole', 'a_s_s', 'a55hole', 'acrotomophilia', 'ahole', 'alabamahotpocket', 'alaskanpipeline', 'anal', 'analimpaler', 'analleakage', 'analprobe', 'anilingus', 'apeshit', 'ar5e', 'arrse', 'arse', 'arsehole', 'assfuck', 'asshole', 'assbag', 'assbandit', 'assbang', 'assbanged', 'assbanger', 'assbangs', 'assbite', 'assclown', 'asscock', 'asscracker', 'asses', 'assface', 'assfaces', 'assfuck', 'assfucker', 'ass-fucker', 'assfukka', 'assgoblin', 'assh0le', 'asshat', 'ass-hat', 'asshead', 'assho1e', 'asshole', 'assholes', 'asshopper', 'ass-jabber', 'assjacker', 'asslick', 'asslicker', 'assmaster', 'assmonkey', 'assmucus', 'assmucus', 'assmunch', 'assmuncher', 'assnigger', 'asspirate', 'ass-pirate', 'assshit', 'assshole', 'asssucker', 'asswad', 'asswhole', 'asswipe', 'asswipes', 'autoerotic', 'autoerotic', 'axwound', 'azazel', 'b!tch', 'b00bs', 'b17ch', 'b1tch', 'babybatter', 'babyjuice', 'ballgag', 'ballgravy', 'balllicking', 'ballsack', 'ballsucking', 'ballbag', 'ballsack', 'bampot', "bang(one's)box", 'bangbros', 'barelylegal', 'barenaked', 'barf', 'bastard', 'bastardo', 'bastards', 'bastinado', 'battyboy', 'bdsm', 'beaner', 'beaners', 'beardedclam', 'beastial', 'beastiality', 'beatch', 'beavercleaver', 'beaverlips', 'beefcurtain', 'beefcurtains', 'beeyotch', 'bellend', 'beotch', 'bescumber', 'bestial', 'bestiality', 'bi+ch', 'biatch', 'bigknockers', 'bigtits', 'bigtits', 'bimbo', 'bimbos', 'bint', 'birdlock', 'bitch', 'bitchtit', 'bitchass', 'bitched', 'bitcher', 'bitchers', 'bitches', 'bitchin', 'bitching', 'bitchtits', 'bitchy', 'blackcock', 'bloodclaat', 'blowjob', 'blowme', 'blowmud', 'blowyourload', 'blowjob', 'blowjobs', 'bluewaffle', 'bluewaffle', 'blumpkin', 'boiolas', 'bollock', 'bollocks', 'bollok', 'bollox', 'bondage', 'boned', 'boner', 'boners', 'bong', 'boob', 'boobies', 'boobs', 'booby', 'booger', 'boong', 'booobs', 'boooobs', 'booooobs', 'booooooobs', 'bootee', 'bootie', 'bootycall', 'booze', 'boozer', 'boozy', 'bosom', 'bosomy', 'breasts', 'brotherfucker', 'brownshowers', 'buceta', 'bugger', 'bullshit', 'bulldyke', 'bulletvibe', 'bullshit', 'bullshits', 'bullshitted', 'bullturds', 'bumblefuck', 'bumclat', 'bummer', 'bung', 'bunghole', 'bunghole', 'bunnyfucker', 'bustaload', 'busty', 'buttfuck', 'buttplug', 'buttcheeks', 'buttfuck', 'buttfucka', 'buttfucker', 'buttmuch', 'buttmunch', 'butt-pirate', 'buttplug', 'c.0.c.k', 'c.o.c.k.', 'c.u.n.t', 'c0ck', 'c-0-c-k', 'c0cksucker', 'cameltoe', 'cameltoe', 'camgirl', 'camslut', 'camwhore', 'carpetmuncher', 'carpetmuncher', 'cawk', 'chesticle', 'chi-chiman', 'chickwithadick', 'child-fucker', 'chinc', 'chincs', 'chink', 'chinky', 'choad', 'choade', 'choade', 'chocice', 'chocolaterosebuds', 'chode', 'chodes', 'chotabags', 'chotabags', 'cipa', 'circlejerk', 'cl1t', 'clevelandsteamer', 'clit', 'clitlicker', 'clitface', 'clitfuck', 'clitorus', 'clits', 'clitty', 'clittylitter', 'cloverclamps', 'clunge', 'clusterfuck', 'cnut', 'c-o-c-k', 'cockpocket', 'cocksnot', 'cocksucker', 'cockass', 'cockbite', 'cockblock', 'cockburger', 'cockeye', 'cockface', 'cockfucker', 'cockhead', 'cockholster', 'cockjockey', 'cockknocker', 'cockknoker', 'cocklump', 'cockmaster', 'cockmongler', 'cockmongruel', 'cockmonkey', 'cockmunch', 'cockmuncher', 'cocknose', 'cocknugget', 'cockshit', 'cocksmith', 'cocksmoke', 'cocksmoker', 'cocksniffer', 'cocksuck', 'cocksuck', 'cocksucked', 'cocksucked', 'cocksucker', 'cock-sucker', 'cocksuckers', 'cocksucking', 'cocksucks', 'cocksucks', 'cocksuka', 'cocksukka', 'cockwaffle', 'coital', 'cokmuncher', 'coksucka', 'commie', 'coochie', 'coochy', 'coon', 'coonnass', 'coons', 'cooter', 'copsomewood', 'coprolagnia', 'coprophilia', 'corksucker', 'cornhole', 'cornhole', 'corpwhore', 'corpwhore', 'crackwhore', 'crap', 'crappy', 'cretin', 'crikey', 'cripple', 'crotte', 'cumchugger', 'cumchugger', 'cumdumpster', 'cumdumpster', 'cumfreak', 'cumfreak', 'cumguzzler', 'cumguzzler', 'cumbubble', 'cumdump', 'cumdump', 'cumdumpster', 'cumguzzler', 'cumjockey', 'cummer', 'cummin', 'cumming', 'cums', 'cumshot', 'cumshots', 'cumslut', 'cumstain', 'cumtart', 'cunilingus', 'cunillingus', 'cunnie', 'cunnilingus', 'cunny', 'cunt', 'c-u-n-t', 'cunthair', 'cunthair', 'cuntass', 'cuntbag', 'cuntbag', 'cuntface', 'cunthole', 'cunthunter', 'cuntlick', 'cuntlick', 'cuntlicker', 'cuntlicker', 'cuntlicking', 'cuntlicking', 'cuntrag', 'cunts', 'cuntsicle', 'cuntsicle', 'cuntslut', 'cunt-struck', 'cunt-struck', 'cyalis', 'cyberfuc', 'cyberfuck', 'cyberfuck', 'cyberfucked', 'cyberfucked', 'cyberfucker', 'cyberfuckers', 'cyberfucking', 'cyberfucking', 'd0ng', 'd0uch3', 'd0uche', 'd1ck', 'd1ld0', 'd1ldo', 'dammit', 'daterape', 'daterape', 'dawgie-style', 'deepthroat', 'deepthroat', 'dendrophilia', 'dick', 'dickhead', 'dickhole', 'dickhole', 'dickshy', 'dickshy', 'dickbag', 'dickbeaters', 'dickdipper', 'dickface', 'dickflipper', 'dickfuck', 'dickfucker', 'dickhead', 'dickheads', 'dickhole', 'dickish', 'dick-ish', 'dickjuice', 'dickmilk', 'dickmonger', 'dickripper', 'dicks', 'dicksipper', 'dickslap', 'dick-sneeze', 'dicksucker', 'dicksucking', 'dicktickler', 'dickwad', 'dickweasel', 'dickweed', 'dickwhipper', 'dickwod', 'dickzipper', 'dildo', 'dildos', 'diligaf', 'dingleberries', 'dingleberry', 'dipship', 'dipshit', 'dirtypillows', 'dirtysanchez', 'dlck', 'dogstyle', 'dog-fucker', 'doggiestyle', 'doggiestyle', 'doggie-style', 'doggin', 'dogging', 'doggystyle', 'doggystyle', 'doggy-style', 'dolcett', 'dominatrix', 'dommes', 'donkeypunch', 'donkeypunch', 'donkeyribber', 'doochbag', 'doofus', 'dookie', 'doosh', 'dopey', 'doubledong', 'doublepenetration', 'douch3', 'douche', 'douchebag', 'douchebags', 'douche-fag', 'douchewaffle', 'douchey', 'dpaction', 'dryhump', 'dumass', 'dumbass', 'dumbass', 'dumbasses', 'dumbcunt', 'dumbfuck', 'dumbshit', 'dumshit', 'eatadick', 'eatadick', 'eathairpie', 'eathairpie', 'eatmyass', 'ejaculate', 'ejaculated', 'ejaculates', 'ejaculates', 'ejaculating', 'ejaculating', 'ejaculatings', 'ejaculation', 'ejakulate', 'erect', 'erection', 'erotic', 'erotism', 'escort', 'essohbee', 'extacy', 'extasy', 'fuck', 'fucker', 'f.u.c.k', 'f_u_c_k', 'f4nny', 'fack', 'fagbag', 'fagfucker', 'fagg', 'fagged', 'fagging', 'faggit', 'faggitt', 'faggot', 'faggotcock', 'faggots', 'faggs', 'fagot', 'fagots', 'fags', 'fagtard', 'faig', 'faigt', 'fannybandit', 'fannyflaps', 'fannyfucker', 'fanyy', 'fartknocker', 'fatass', 'fcuk', 'fcuker', 'fcuking', 'fecal', 'felch', 'felcher', 'felching', 'fellate', 'fellatio', 'feltch', 'feltcher', 'femalesquirting', 'femdom', 'fenian', 'fingerbang', 'fingerfuck', 'fingerfuck', 'fingerfucked', 'fingerfucked', 'fingerfucker', 'fingerfucker', 'fingerfuckers', 'fingerfucking', 'fingerfucking', 'fingerfucks', 'fingerfucks', 'fistfuck', 'fistfuck', 'fisted', 'fistfuck', 'fistfucked', 'fistfucked', 'fistfucker', 'fistfucker', 'fistfuckers', 'fistfuckers', 'fistfucking', 'fistfucking', 'fistfuckings', 'fistfuckings', 'fistfucks', 'fistfucks', 'fisting', 'fisty', 'fleshflute', 'flogthelog', 'floozy', 'foad', 'fondle', 'fooker', 'footfetish', 'footjob', 'foreskin', 'frotting', 'fubar', 'fuck', 'fuck', 'f-u-c-k', 'fuckbuttons', 'fuckhole', 'fuckhole', 'fuckoff', 'fuckpuppet', 'fuckpuppet', 'fucktrophy', 'fucktrophy', 'fuckyomama', 'fuckyomama', 'fuckyou', 'fucka', 'fuckass', 'fuck-ass', 'fuck-ass', 'fuckbag', 'fuck-bitch', 'fuck-bitch', 'fuckboy', 'fuckbrain',
               'fuckbutt', 'fuckbutter', 'fucked', 'fuckedup', 'fucker', 'fuckers', 'fuckersucker', 'fuckface', 'fuckhead', 'fuckheads', 'fuckhole', 'fuckin', 'fucking', 'fuckings', 'fuckingshitmotherfucker', 'fuckme', 'fuckme', 'fuckmeat', 'fuckmeat', 'fucknugget', 'fucknut', 'fucknutt', 'fuckoff', 'fucks', 'fuckstick', 'fucktard', 'fuck-tard', 'fucktards', 'fucktart', 'fucktoy', 'fucktoy', 'fucktwat', 'fuckup', 'fuckwad', 'fuckwhit', 'fuckwit', 'fuckwitt', 'fudgepacker', 'fudgepacker', 'fudge-packer', 'fuker', 'fukker', 'fukkers', 'fukkin', 'fuks', 'fukwhit', 'fukwit', 'futanari', 'fux0r', 'fvck', 'fxck', 'gangbang', 'gangbang', 'gang-bang', 'gang-bang', 'gangbanged', 'gangbangs', 'gassyass', 'gassyass', 'gaysex', 'gayass', 'gaybob', 'gaydo', 'gayfuck', 'gayfuckist', 'gaysex', 'gaytard', 'gaywad', 'genderbender', 'giantcock', 'gigolo', 'gippo', 'glans', 'goatcx', 'goatse', 'goddamn', 'goddamned', 'god-damned', 'goddamnit', 'godsdamn', 'gokkun', 'goldenshower', 'goldenshower', 'googirl', 'goodpoop', 'gooks', 'goregasm', 'groupsex', 'gspot', 'g-spot', 'gtfo', 'h0m0', 'h0mo', 'handjob', 'handjob', 'hardcoresex', 'hentai', 'heroin', 'herpes', 'hobag', 'hoer', 'hom0', 'homodumbshit', 'homoerotic', 'homoey', 'honkey', 'honky', 'hooker', 'hore', 'horniest', 'horny', 'hotcarl', 'hotchick', 'hotsex', 'howtomurdep', 'howtomurder', 'humped', 'humping', 'iberianslap', 'inbred', 'incest', 'intercourse', 'jackoff', 'jackass', 'jackasses', 'jackhole', 'jackoff', 'jack-off', 'jailbait', 'jailbait', 'japs', 'jerk', 'jerkoff', 'jerk0ff', 'jerkass', 'jerked', 'jerkoff', 'jerk-off', 'jigaboo', 'jiggaboo', 'jiggerboo', 'jism', 'jizm', 'jizm', 'jizz', 'jizzed', 'jock', 'juggs', 'junglebunny', 'junglebunny', 'kafir', 'kike', 'kikes', 'kinbaku', 'kinkster', 'knobead', 'knobed', 'knobend', 'knobhead', 'knobjocky', 'knobjokey', 'kooch', 'kooches', 'kootch', 'kunilingus', 'kunt', 'kwif', 'kyke', 'l3i+ch', 'l3itch', 'labia', 'lameass', 'lardass', 'leatherrestraint', 'leatherstraightjacket', 'lemonparty', 'leper', 'lezza', 'lezzie', 'lolita', 'lovemaking', 'lube', 'm0f0', 'm0fo', 'm45terbate', 'ma5terb8', 'ma5terbate', 'mafugly', 'mafugly', 'makemecome', 'malesquirting', 'masterb8', 'masterbat*', 'masterbat3', 'masterbate', 'master-bate', 'master-bate', 'masterbating', 'masterbation', 'masterbations', 'masturbate', 'masturbating', 'masturbation', 'mcfagget', 'menageatrois', 'meth', 'm-fucking', 'microphallus', 'milf', 'missionaryposition', 'mof0', 'mofo', 'mo-fo', 'molest', 'moolie', 'moron', 'mothafuck', 'mothafucka', 'mothafuckas', 'mothafuckaz', 'mothafucked', 'mothafucked', 'mothafucker', 'mothafuckers', 'mothafuckin', 'mothafucking', 'mothafucking', 'mothafuckings', 'mothafucks', 'motherfucker', 'motherfucker', 'motherfuck', 'motherfucka', 'motherfucked', 'motherfucker', 'motherfuckers', 'motherfuckin', 'motherfucking', 'motherfuckings', 'motherfuckka', 'motherfucks', 'moundofvenus', 'muffdiver', 'muffpuff', 'muffpuff', 'muffdiver', 'muffdiving', 'murder', 'mutha', 'muthafecker', 'muthafuckker', 'muther', 'mutherfucker', 'n1gga', 'n1gger', 'nambla', 'nawashi', 'needthedick', 'negro', 'nignog', 'nigaboo', 'nigg3r', 'nigg4h', 'nigga', 'niggah', 'niggas', 'niggaz', 'nigger', 'niggers', 'niglet', 'nig-nog', 'nimphomania', 'nobjokey', 'nobhead', 'nobjocky', 'nobjokey', 'nonce', 'nsfwimages', 'nude', 'nudity', 'numbnuts', 'nutsack', 'nutsack', 'nympho', 'nymphomania', 'octopussy', 'omorashi', 'onecuptwogirls', 'oneguyonejar', 'opiate', 'opium', 'orgasim', 'orgasims', 'orgasm', 'orgasmic', 'orgasms', 'orgies', 'orgy', 'p.u.s.s.y.', 'p0rn', 'paedophile', 'paki', 'peckerhead', 'pedobear', 'pedophile', 'pedophilia', 'pedophiliac', 'peepee', 'pegging', 'penial', 'penile', 'penis', 'penisbanger', 'penisfucker', 'penispuffer', 'phallic', 'phonesex', 'phonesex', 'phuck', 'phuk', 'phuked', 'phuking', 'phukked', 'phukking', 'phuks', 'phuq', 'pieceofshit', 'pigfucker', 'pillowbiter', 'pimp', 'pimpis', 'pisspig', 'pissflaps', 'pisspig', 'pleasurechest', 'polack', 'polesmoker', 'polesmoker', 'pollock', 'ponyplay', 'poof', 'poon', 'poonani', 'poonany', 'poontang', 'poopchute', 'poopchute', 'poopuncher', 'porchmonkey', 'porchmonkey', 'porn', 'porno', 'pornography', 'pornos', 'potty', 'prick', 'pricks', 'prickteaser', 'prig', 'princealbertpiercing', 'pron', 'prostitute', 'pthc', 'pube', 'pubes', 'pubic', 'pubis', 'punani', 'punanny', 'punany', 'puss', 'pusse', 'pussi', 'pussies', 'pussy', 'pussyfart', 'pussyfart', 'pussypalace', 'pussypalace', 'pussylicking', 'pussypounder', 'pussys', 'queaf', 'queaf', 'queef', 'queerbait', 'queerhole', 'queero', 'quim', 'raghead', 'ragingboner', 'rape', 'raped', 'raper', 'rapey', 'raping', 'rapist', 'raunch', 'reetard', 'renob', 'retard', 'retarded', 'reversecowgirl', 'rimjaw', 'rimjob', 'rimming', 'ritard', 'rosypalm', 'rosypalmandher5sisters', 'rtard', 'r-tard', 'rustytrombone', 'shit', 's.h.i.t.', 's.o.b.', 's_h_i_t', 'sadism', 'sadist', 'sandnigger', 'sandnigger', 'sausagequeen', 'schizo', 'schlong', 'scissoring', 'scroat', 'scrog', 'scrot', 'scrote', 'scum', 'seks', 'semen', 'sexo', 'sh!+', 'sh!t', 'sh1t', 's-h-1-t', 'shag', 'shagger', 'shaggin', 'shagging', 'shavedbeaver', 'shavedpussy', 'shemale', 'shi+', 'shibari', 'shit', 's-h-i-t', 'shitass', 'shitfucker', 'shitfucker', 'shitass', 'shitbag', 'shitbagger', 'shitblimp', 'shitbrains', 'shitbreath', 'shitcanned', 'shitcunt', 'shitdick', 'shite', 'shiteater', 'shited', 'shitey', 'shitface', 'shitfaced', 'shitfuck', 'shitfull', 'shithead', 'shitheads', 'shithole', 'shithouse', 'shiting', 'shitings', 'shits', 'shitspitter', 'shitstain', 'shitt', 'shitted', 'shitter', 'shitters', 'shitters', 'shittier', 'shittiest', 'shitting', 'shittings', 'shitty', 'shiz', 'shiznit', 'shota', 'skullfuck', 'slanteye', 'slave', 'slut', 'slutbucket', 'slutbucket', 'slutbag', 'slutdumper', 'slutkiss', 'sluts', 'smut', 'smutty', 'snuff', 's-o-b', 'sodoff', 'sodomize', 'sodomy', 'sonofabitch', 'sonofamotherlessgoat', 'sonofawhore', 'son-of-a-bitch', 'splooge', 'sploogemoose', 'spooge', 'spook', 'spreadlegs', 'spunk', 'stfu', 'stiffy', 'stoned', 'strapon', 'strapon', 'strappado', 'stripclub', 'styledoggy', 'suckass', 'suicidegirls', 'sultrywomen', 'sumofabiatch', 't1tt1e5', 't1tties', 'taff', 'taig', 'takingthepiss', 'tard', 'teabagging', 'teabagging', 'teat', 'teets', 'teez', 'testee', 'testes', 'testical', 'testicle', 'testis', 'threesome', 'throating', 'thundercunt', 'titwank', 'titwank', 'titfuck', 'titi', 'tities', 'tits', 'titt', 'tittie5', 'tittiefucker', 'titties', 'titty', 'tittyfuck', 'tittyfucker', 'tittywank', 'titwank', 'tosser', 'towelhead', 'tramp', 'tranny', 'tribadism', 'tubgirl', 'tubgirl', 'turd', 'tush', 'tushy', 'tw4t', 'twat', 'twathead', 'twatlips', 'twats', 'twatty', 'twatwaffle', 'twofingers', 'twofingerswithtongue', 'twogirlsonecup', 'twunt', 'twunter', 'unclefucker', 'undies', 'undressing', 'upskirt', 'urethraplay', 'urophilia', 'v14gra', 'v1gra', 'vagina', 'vajayjay', 'va-j-j', 'venusmound', 'veqtable', 'violetwand', 'vixen', 'vjayjay', 'vorarephilia', 'vulva', 'wang', 'wank', 'wanker', 'wankjob', 'wanky', 'wazoo', 'wetdream', 'wetback', 'wh0re', 'wh0reface', 'whoar', 'whore', 'whorealicious', 'whorebag', 'whored', 'whoreface', 'whorehopper', 'whorehouse', 'whores', 'whoring', 'wigger', 'windowlicker', 'wrinkledstarfish', 'yaoi', 'yeasty', 'yellowshowers', 'yiffy', 'yobbo', 'zibbi', 'zoophilia', 'zubb']
        for i in eng:
            if i in text:
                ge = 7
